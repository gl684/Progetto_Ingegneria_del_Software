...
class Ui_FinestraVisualizzaCliente(object):
    def configurazioneInteraccia(self, FinestraVisualizzaCliente):
        ...
        self.ButtonModificaCliente.setStyleSheet(self.stileButton())  # Applica lo stile
        ...
        self.ButtonEliminaCliente.setStyleSheet(self.stileButton())  # Applica lo stile
        ...
        self.ButtonChiudi.setStyleSheet(self.stileButton())  # Applica lo stile
