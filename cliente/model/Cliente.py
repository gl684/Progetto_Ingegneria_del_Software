...
class Cliente:
    def __init__(self, email, telefono, tipo_cliente, id=None, nome=None, cognome=None, cf=None, nome_azienda=None,
                 partita_iva=None, indirizzo=None, indirizzo_azienda=None):
        ...
        self.indirizzo_azienda = indirizzo_azienda
    ...
    def descrizione(self):
        if self.tipo_cliente == "Privato":
            ...
            return f"Cliente Azienda: {self.nome_azienda}, P.IVA: {self.partita_iva}, Indirizzo: {self.indirizzo_azienda}, Email: {self.email}, Telefono: {self.telefono}"
        else:
