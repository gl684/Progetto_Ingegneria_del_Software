...
class Ui_FinestraInserisciCliente(object):
    def configurazioneInterfaccia(self, FinestraInserisciCliente):
        ...
        self.ButtonConferma.setGeometry(QtCore.QRect(90, 460, 171, 50))
        self.ButtonConferma.setStyleSheet(self.stileButton())
        self.ButtonConferma.setText("Conferma")

        self.ButtonAnnulla = QtWidgets.QPushButton(self.CentralWidget)
        self.ButtonAnnulla.setGeometry(QtCore.QRect(300, 460, 171, 50))
        self.ButtonAnnulla.setStyleSheet(self.stileButton())
