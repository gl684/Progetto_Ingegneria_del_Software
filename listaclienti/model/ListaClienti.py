...
class ListaClienti:
    def __init__(self):
        self.lista_clienti = []
        self.load_data()  # Carica i dati salvati all'avvio

    def aggiungi_cliente(self, cliente):
        self.lista_clienti.append(cliente)
        self.save_data()  # Salva i dati dopo l'aggiunta di un cliente
    ...
    def rimuovi_cliente_by_id(self, cliente_id):
    ...
    def elimina_cliente(self, cliente_id):
        ...
        self.save_data()  # Salva i dati dopo l'eliminazione di un cliente
    ...
    def modifica_cliente(self, cliente_modificato):
        for i, cliente in enumerate(self.lista_clienti):
            if cliente.id == cliente_modificato.id:
                ...
                break
        self.save_data()  # Salva i dati dopo la modifica
